...
$string['pluginname']      = 'Bulk rubric assignment';
$string['title']           = 'Bulk rubric assignment';
...
$string['error:no_course'] = 'You must select a course';
$string['form_submit']     = 'Update rubrics';
$string['update_success']  = 'Rubric updated for {$a->count} assignment(s).';
